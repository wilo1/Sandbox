...
define(["module", "vwf/model"], function(module, model) {
    ...
    return model.load(module, {
        ...
        addWire: function(node1, node2, prop1, prop2, dott, dots, funcstring) {
            if (prop1 == 'wires' || prop2 == 'wires') {
                console.log('wireing the wire property is insane.');
                return
            };
        ...
        creatingProperty: function(nodeID, propertyName, propertyValue) {
            this.initializingProperty(nodeID, propertyName, propertyValue);
        },
        ...
        settingProperty: function(nodeID, propertyName, propertyValue) {
            ...
            if (propertyName == 'wires') {
                ...
                for (var i in propertyValue) {
                    ...
                    this.addWire(nodeID, source, targetprop, sourceprop, targetdot, sourcedot, propertyValue[i][5]);
                    if (this.objects[source]) {
            ...
            if (wireout) {
                ...
                if (oldval != oldval2) {
                    ...
                    vwf.setProperty(target, targetprop, newval);
                    this.disable = true;
