...
function socketThreadProxy(host,options)
{
	...
	{
		this.postMessage({type:CONNECT,host:this.host,options:this.options});
	}
	this.disconnect = function()
	{
		this.postMessage({type:DISCONNECT,message:null});
	}
	this.send = function(message)
	{
		this.postMessage({type:SEND,message:message});
	}
